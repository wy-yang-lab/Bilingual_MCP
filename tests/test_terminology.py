...
class TestTerminologyChecker:
    ...
    def test_english_login_check(self):
        """Test that 'login' is flagged and 'sign in' is suggested."""
        text = "Please login to continue"
        issues = self.checker.check_text(text, "en")
    ...
    def test_japanese_login_check(self):
        """Test Japanese terminology checking."""
        text = "ログインしてください"
        issues = self.checker.check_text(text, "jp")
    ...
    def test_unsupported_language(self):
        ...
        issues = self.checker.check_text(text, "fr")
